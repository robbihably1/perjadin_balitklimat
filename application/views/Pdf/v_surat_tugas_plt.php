...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        ...
        ?>
            ...
            <p style="text-align:left;margin-top:490px;margin-left:420px;width:92%;position:absolute;z-index:2"><b>Plh. Kepala Balai,</b>
            <p style="text-align:left;margin-top:620px;margin-left:420px;width:92%;position:absolute;z-index:3"><b><?php echo $p->nama_plt ?></b>
            <p style="text-align:left;margin-top:650px;margin-left:420px;width:92%;position:absolute;z-index:4"><b>NIP.<?php echo ' ' . $p->nip_plt ?></b>
